...
def songs(request):
    songs = req.get("http://songs-sn-labs-saravanankup.labs-prod-openshift-san-a45631dc5778dc6371c67d206ba9ae5c-0000.us-east.containers.appdomain.cloud/song").json()
    return render(request, "songs.html", {"songs": songs["songs"]})

def photos(request):
    photos = req.get("https://pictures.25wo3wq40gzm.us-south.codeengine.appdomain.cloud/picture").json()
